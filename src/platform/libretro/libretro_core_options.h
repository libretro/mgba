...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "Solar Sensor",
      NULL,
      "Sets sunlight intensity for games with cartridge solar sensors (e.g. Boktai). External sensor mode also supports R3 + Right Stick X+ to set the solar meter.",
      NULL,
      "input",
      {
         { "sensor", "Use device sensor if available" },
         { "external", "Use external sensor (Ojo del Sol)" },
         { "0",      "Static: 0 bars" },
         { "1",      "Static: 1 bars" },
         { "2",      "Static: 2 bars" },
         { "3",      "Static: 3 bars" },
